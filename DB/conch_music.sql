...
--
-- Host: localhost    Database: Conch_music
-- ------------------------------------------------------
...
CREATE TABLE `singer_info` (
  ...
  `singer_text` text,
  `fanNo` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `user_sheet` (
  ...
  `sheet_num` int(11) DEFAULT '0',
  `sheet_pic` varchar(100) DEFAULT 'images/default_music_pic.png',
...
-- Dump completed on 2018-12-05 13:01:01
